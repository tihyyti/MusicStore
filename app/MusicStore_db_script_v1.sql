...
CREATE TABLE Store (
    ...
    storeManager_id INT
    --FOREIGN KEY(storeManager_id) REFERENCES Customer(id)
);
...
CREATE TABLE ShoppingCart (
    ...
    cartProd_11_id INT,
    cartProd_12_id INT
    --FOREIGN KEY(cartStore_id) REFERENCES Store(id),
    --FOREIGN KEY(cartCustomer_id) REFERENCES Customer(id),
    --FOREIGN KEY(cartProd_1_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_2_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_3_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_4_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_5_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_6_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_7_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_8_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_9_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_10_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_11_id) REFERENCES Product(id),
    --FOREIGN KEY(cartProd_12_id) REFERENCES Product(id)
);
...
CREATE TABLE Product (
  ...
  -- Cumulative daily fields
    ...
    --FOREIGN KEY(productImage_id) REFERENCES ProductImage(id)
);
