...
INSERT INTO MStore_v1.Store (id, storeManagerName, storeName, storeTaxId, storePhone, storeEmail, storeAddress, storeLogoUrl, storeManager_id, last_login, storeManagerPassw)
VALUES
(1,'John Doe', 'Vintage Instruments Store', 'TAX1234567890', '123-456-7890', 'vintage@store.com', '123 Vintage St, Music City', 'http://example.com/logo1.png', 1, '2024_01_01' 'password123'),
(2,'Jane Smith', 'Modern Instruments Store', 'TAX0987654321', '098-765-4321', 'modern@store.com', '456 Modern Ave, Music City', 'http://example.com/logo2.png', 2, '2024_01_02', 'password456',);

-- Insert data into Customer table
INSERT INTO MStore_v1.Customer (id, store_id, custoName, custoEmail, custoPhone, custoStatus, custoBlocked, last_login, custoPassw) VALUES
(1, 1, 'Alice', 'alice@example.com', '111-222-3333', TRUE, FALSE, 2024.01.01, alicepass),
(2, 1, 'Bob', 'bob@example.com', '222-333-4444', FALSE, FALSE, 2024.01.02, bobpass),
(3, 2, 'Charlie', 'charlie@example.com', '333-444-5555', TRUE, FALSE, , 2024.01.03, charliepass),
(4, 2, 'Dave', 'dave@example.com', '444-555-6666', FALSE, TRUE, 2024.01.04, davepass);
